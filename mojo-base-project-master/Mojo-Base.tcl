# 
# Project automation script for Mojo-Base 
# 
...
set myProject "Mojo-Base"
set myScript "Mojo-Base.tcl"
...
proc add_source_files {} {
   ...
   xfile add "src/cpu/control/control.v"
   xfile add "src/cpu/control/control_fsm_tb.v"
   xfile add "src/cpu/control/test_control_tb.v"
   xfile add "src/cpu/incrementer.v"
   xfile add "src/cpu/regfile/regfile_top.v"
   xfile add "src/mojo.ucf"
   xfile add "src/mojo_top.v"
   xfile add "src/tb/mem_tb.v"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/eric/fpga/sm83-fpga/mojo-base-project-master/syn/xst" -process "Synthesize - XST"
